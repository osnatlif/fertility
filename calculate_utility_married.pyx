...
cpdef tuple calculate_utility_married(double[:, :, :, :, :, :, :, :, :, :, :, :] w_emax,
    ...
    if t == c.max_period - 1:
        ...
        if kids_temp < 3:
            ...
            kids_temp_preg = 3
        u_wife[0]     = uc_wife[0]     + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index, h_exp_index, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_husband[0]  = uc_husband[0]  + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index, h_exp_index, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_wife[1]     = uc_wife[1]     + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index, h_exp_index, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_husband[1]  = uc_husband[1]  + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index, h_exp_index, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_wife[2]     = uc_wife[2]     + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index, h_exp_index_f, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_husband[2]  = uc_husband[2]  + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index, h_exp_index_f, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_wife[3]     = uc_wife[3]     + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index, h_exp_index_f, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_husband[3]  = uc_husband[3]  + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index, h_exp_index_f, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_wife[4]     = uc_wife[4]     + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index, h_exp_index_p, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_husband[4]  = uc_husband[4]  + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index, h_exp_index_p, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_wife[5]     = uc_wife[5]     + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index, h_exp_index_p, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_husband[5]  = uc_husband[5]  + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index, h_exp_index_p, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_wife[6]     = uc_wife[6]     + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index_f, h_exp_index, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_husband[6]  = uc_husband[6]  + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index_f, h_exp_index, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_wife[7]     = uc_wife[7]     + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index_f, h_exp_index, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_husband[7]  = uc_husband[7]  + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index_f, h_exp_index, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_wife[8]     = uc_wife[8]     + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index_f, h_exp_index_f, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_husband[8]  = uc_husband[8]  + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index_f, h_exp_index_f, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_wife[9]     = uc_wife[9]     + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index_f, h_exp_index_f, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_husband[9]  = uc_husband[9]  + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index_f, h_exp_index_f, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_wife[10]    = uc_wife[10]    + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index_f, h_exp_index_p, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_husband[10] = uc_husband[10] + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index_f, h_exp_index_p, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_wife[11]    = uc_wife[11]    + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index_f, h_exp_index_p, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_husband[11] = uc_husband[11] + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index_f, h_exp_index_p, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_wife[12]    = uc_wife[12]    + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index_p, h_exp_index, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_husband[12] = uc_husband[12] + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index_p, h_exp_index, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_wife[13]    = uc_wife[13]    + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index_p, h_exp_index, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_husband[13] = uc_husband[13] + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index_p, h_exp_index, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_wife[14]    = uc_wife[14]    + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index_p, h_exp_index_f, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_husband[14] = uc_husband[14] + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index_p, h_exp_index_f, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_wife[15]    = uc_wife[15]    + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index_p, h_exp_index_f, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_husband[15] = uc_husband[15] + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index_p, h_exp_index_f, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_wife[16]    = uc_wife[16]    + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index_p, h_exp_index_p, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_husband[16] = uc_husband[16] + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index_p, h_exp_index_p, kids_temp, wife.health, husband.health, w_home_time_index, h_home_time_index, wife_ability_index, husband_ability_index]
        u_wife[17]    = uc_wife[17]    + c.beta0 * w_emax[t+1, wife.schooling, husband.schooling, w_exp_index_p, h_exp_index_p, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
        u_husband[17] = uc_husband[17] + c.beta0 * h_emax[t+1, wife.schooling, husband.schooling, w_exp_index_p, h_exp_index_p, kids_temp_preg, wife.health, husband.health, w_home_time_index_preg, h_home_time_index_preg, wife_ability_index, husband_ability_index]
